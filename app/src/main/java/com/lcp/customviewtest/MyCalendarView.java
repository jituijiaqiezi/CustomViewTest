...
public class MyCalendarView extends FrameLayout {
    ...
    public interface OnDateChangeListener {
         ...
         */
        void onSelectedDayChange(@NonNull MyCalendarView view, int year, int month, int dayOfMonth);
    }
    ...
    public MyCalendarView(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        switch (mode) {
            case MODE_HOLO:
                mDelegate = new MyCalendarViewLegacyDelegate(
                        this, context, attrs, defStyleAttr, defStyleRes);
                break;
            case MODE_MATERIAL:
                mDelegate = new MyCalendarViewMaterialDelegate(
                        this, context, attrs, defStyleAttr, defStyleRes);
                break;
            default:
    ...
    public CharSequence getAccessibilityClassName() {
        return MyCalendarView.class.getName();
    }
    ...
    abstract static class AbstractCalendarViewDelegate implements CalendarViewDelegate {
        ...
        protected MyCalendarView mDelegator;
        protected Context mContext;
        protected Locale mCurrentLocale;

        AbstractCalendarViewDelegate(MyCalendarView delegator, Context context) {
