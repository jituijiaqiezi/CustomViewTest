...
public abstract class MyExploreByTouchHelper extends View.AccessibilityDelegate {
    ...
    /**
     * Factory method to create a new {@link MyExploreByTouchHelper}.
     *
    ...
    private AccessibilityNodeInfo createNodeForHost() {
        ...
        if (mTempArray == null) {
            mTempArray = new ArrayList<Integer>();
        } else {
            mTempArray.clear();
        }
        final List<Integer> virtualViewIds = mTempArray;
    ...
    private class ExploreByTouchNodeProvider extends AccessibilityNodeProvider {
        ...
        public AccessibilityNodeInfo createAccessibilityNodeInfo(int virtualViewId) {
            return MyExploreByTouchHelper.this.createNode(virtualViewId);
        }

        @Override
        public boolean performAction(int virtualViewId, int action, Bundle arguments) {
            return MyExploreByTouchHelper.this.performAction(virtualViewId, action, arguments);
        }
    }
}
