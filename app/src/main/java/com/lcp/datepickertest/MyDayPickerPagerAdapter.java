...
public class MyDayPickerPagerAdapter extends PagerAdapter {
    ...
    public MyDayPickerPagerAdapter(@NonNull Context context, @LayoutRes int layoutResId,
    ...
    public void setFirstDayOfWeek(int weekStart) {
        ...
        for (int i = 0; i < count; i++) {
            final MySimpleMonthView monthView = mItems.valueAt(i).calendar;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final MySimpleMonthView v = (MySimpleMonthView) itemView.findViewById(mCalendarViewId);
    ...
    public CharSequence getPageTitle(int position) {
        final MySimpleMonthView v = mItems.get(position).calendar;
        if (v != null) {
    ...
    public MySimpleMonthView getView(Object object) {
        if (object == null) {
            return null;
        }
        final ViewHolder holder = (ViewHolder) object;
    ...
    private final MySimpleMonthView.OnDayClickListener mOnDayClickListener = new MySimpleMonthView.OnDayClickListener() {
        @Override
        public void onDayClick(MySimpleMonthView view, Calendar day) {
            if (day != null) {
                setSelectedDay(day);

                if (mOnDaySelectedListener != null) {
                    mOnDaySelectedListener.onDaySelected(MyDayPickerPagerAdapter.this, day);
                }
            }
        }
    };
    ...
    private static class ViewHolder {
        ...
        public final MySimpleMonthView calendar;

        public ViewHolder(int position, View container, MySimpleMonthView calendar) {
    ...
    public interface OnDaySelectedListener {
        public void onDaySelected(MyDayPickerPagerAdapter view, Calendar day);
    }
}
