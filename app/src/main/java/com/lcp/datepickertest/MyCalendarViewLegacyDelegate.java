...
class MyCalendarViewLegacyDelegate extends MyCalendarView.AbstractCalendarViewDelegate {
    ...
    MyCalendarViewLegacyDelegate(MyCalendarView delegator, Context context, AttributeSet attrs,
        ...
        if (!MyCalendarView.parseDate(minDate, mMinDate)) {
            MyCalendarView.parseDate(DEFAULT_MIN_DATE, mMinDate);
        }
        final String maxDate = a.getString(R.styleable.CalendarView_android_maxDate);
        if (!MyCalendarView.parseDate(maxDate, mMaxDate)) {
            MyCalendarView.parseDate(DEFAULT_MAX_DATE, mMaxDate);
        }
        ...
        View content = layoutInflater.inflate(R.layout.my_calendar_view, null, false);
    ...
    private void setUpListView() {
        ...
        mListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                MyCalendarViewLegacyDelegate.this.onScrollStateChanged(view, scrollState);
            }

            public void onScroll(
                    AbsListView view, int firstVisibleItem, int visibleItemCount,
                    int totalItemCount) {
                MyCalendarViewLegacyDelegate.this.onScroll(view, firstVisibleItem,
