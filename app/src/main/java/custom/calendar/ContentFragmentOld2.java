 ...
 */
public class ContentFragmentOld2 extends Fragment  {
    CalendarActivity calendarActivity;
    private static final String TAG = ContentFragmentOld2.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calendar_old3, container, false);
        init(view);
        return view;
    }
    ...
    private void init(final View view) {
        ...
        recyclerViewContent.setLayoutManager(new CustomGridLayoutManager(getContext(), 7,false));
        ...
        recyclerViewTime.setLayoutManager(new CustomLinearLayoutManager(getContext(),false));
    ...
    public CalendarScrollView getScrollView() {
        return scrollView;
    }
}
