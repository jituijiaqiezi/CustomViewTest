...
public class FlipShareActivity extends AppCompatActivity implements View.OnClickListener {

    private Button mBtnLeftTop,mBtnMiddleTop,mBtnRightTop,mBtnLeftBottom,mBtnMiddleBottom,mBtnRightBottom;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_flip_share);
            ...
            case R.id.btn_left_top:
                ...
                share.setOnFlipClickListener(new FlipShareView.OnFlipClickListener() {
                    ...
                    public void onItemClick(int position) {
                        Toast.makeText(FlipShareActivity.this,"position "+position+" is clicked.",Toast.LENGTH_SHORT).show();
                    }
